	...
	public void onLocationChanged(Location loc) {
		if (numberOfUpdates < MAX_NUMBER_OF_UPDATES) {
			...
			if (loc != null) {
				...
				GPS_Singleton.getInstance().setLatitud(loc.getLatitude());
				GPS_Singleton.getInstance().setLongitud(loc.getLongitude());
			} else {
				message = "verifique su GPS. :GPSlistener Location null";
